...
This will start the application in development mode. Open [http://localhost:9002](http://localhost:9002) to view it in your browser. The page will auto-update as you make changes to the code.
